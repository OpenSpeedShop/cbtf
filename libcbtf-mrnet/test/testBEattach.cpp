...
int main (int argc, char **argv)
{
    ...
    registerXML(boost::filesystem::path(BUILDDIR) / "testBEattach.xml");
    ...
    *topology_value = boost::filesystem::path(BUILDDIR) / "testBEattach.topology";

std::cerr << "AFTER TOPOLOGY" << std::endl;
