...
namespace KrellInstitute { namespace CBTF { namespace Impl {
     ...
     *          changed by modifying the KRELL_INSTITUTE_CBTF_RAISE_MAXARGS
     *          macro definition.
     *
    ...
    #define KRELL_INSTITUTE_CBTF_RAISE_MAXARGS 25

    #define KRELL_INSTITUTE_CBTF_RAISE_ARG(z, n, unused) \
        formatter % arg##n ;

    #define KRELL_INSTITUTE_CBTF_RAISE(z, n, unused)                     \
        template <                                                       \
        ...
        {                                                                \
            ...
            BOOST_PP_REPEAT(n, KRELL_INSTITUTE_CBTF_RAISE_ARG, ~)        \
            throw ExceptionType(formatter.str());                        \
        }

    BOOST_PP_REPEAT(BOOST_PP_INC(KRELL_INSTITUTE_CBTF_RAISE_MAXARGS), \
                    KRELL_INSTITUTE_CBTF_RAISE, ~)
